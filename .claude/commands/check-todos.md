...
4. Check for established workflows:
   ...
   - Match file paths in todo to domain patterns (`services/` → service workflow, `components/` → component workflow)
...
6. Handle user choice:
   ...
   - **Option "Brainstorm approach"**: Keep todo in file, discuss approach with user
...
3. Fix Dashboard test mocks (2025-11-25 01:30)
